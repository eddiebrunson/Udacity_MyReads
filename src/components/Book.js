...
// This is the Book component that that contains each book object
  ...
  updateShelf = (bookId, shelf) => {
    ...
    render() {
      const shelf = this.state.shelf ? this.state.shelf : "none"
    	...
    	<div className="books-title">{this.props.title}</div>
    	<div className="books-authors">{this.props.authors}</div>
    	</div>
    )
   }
}
